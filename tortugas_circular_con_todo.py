...
class ImageLoaderApp(QMainWindow):
    def __init__(self):
        ...
        self.red_button.clicked.connect(lambda: self.set_color(Qt.red))
        self.color_button_layout.addWidget(self.red_button)

        self.blue_button = QPushButton("Azul")
        self.blue_button.clicked.connect(lambda: self.set_color(Qt.blue))
        self.color_button_layout.addWidget(self.blue_button)

        self.green_button = QPushButton("Verde")
        self.green_button.clicked.connect(lambda: self.set_color(Qt.green))
        self.color_button_layout.addWidget(self.green_button)
